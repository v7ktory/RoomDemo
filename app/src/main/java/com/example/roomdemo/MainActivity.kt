...
fun TitleRow(head1: String, head2: String, head3: String) {
    Row(
        ...
        Text(head2, color = Color.White, modifier = Modifier.weight(0.45f))
        Text(head3, color = Color.White, modifier = Modifier.weight(0.45f))
    }
}
...
fun ProductRow(id: Int, name: String, quantity: Int) {
    Row(
        ...
        Text(name, modifier = Modifier.weight(0.45f))
        Text(quantity.toString(), modifier = Modifier.weight(0.45f))
    }
}
